...
popd
	...
	ln -sf libsane-canon_pixma.so.1.0.0 ${RPM_BUILD_ROOT}%{_libdir}/sane/libsane-canon_pixma.so
	ln -sf libsane-canon_pixma.so.1.0.0 ${RPM_BUILD_ROOT}%{_libdir}/sane/libsane-canon_pixma.so.1
