...
void jpeg_RW_src (j_decompress_ptr, FILE *);
 ...
 */
void jpeg_RW_src (j_decompress_ptr cinfo, FILE *ctx)
{
  my_source_mgr *src;
...
void output_no_message(j_common_ptr cinfo)
{
	(void)cinfo;
	/* do nothing */
}
...
CMT_Status init_canon_options(canon_sane_t * handled){
